            ...
            <div class="member-form">
                ...
                <div class="mb50">
                    <ul class="list guide">
                        ...
                        <li>개인정보 수집에 대한 동의를 거부할 권리가 있으며, 회원 가입 시 개인정보 수집을 동의함으로 간주합니다.</li>
                    </ul>
                    <span class="check">
                    ...
                    <fieldset>
                        ...
                        <div class="join-box">
                            ...
                            <div class="basic">
                                ...
                                <input type="text" id="youPassC"name="youPassC"  maxlength="20" placeholder="비밀번호를 적어주세요!">
    ...
    <script>
        ...
        function joinChecks(){
            ...
            if(!getNick.test($("#youNickName").val())){
                $("#youNickNameComment").text("닉네임을 다시 설정하세요.");
                $("#youNickName").val("");
                return false;
            }
            ...
            //비밀번호 공백 검사 
            if($("#youPass").val() == ""){
                $("#youPassComment").text("비밀번호을 입력해주세요!");
                return false;
            }
            ...
            //     $("#youPassComment").text("영문,숫자, 특수문자를 포함하여 입력해주세요.");
            //     return false;
            // }

            // 비밀번호 재확인 공백
            if($("#youPassC").val() == ""){
                $("#youPassCComment").text("비밀번호를 재확인해주세요.");
                return false;
            }

            //비밀번호 재확인
            if(getPass !== $("#youPassC").val()){
                $("#youPassCComment").text("비밀번호가 일치하지 않습니다. 다시 확인해주세요.");
                return false;
            }
            ...
            //이름 유효성 검사 
            let getName = RegExp(/^[가-힣|a-z|A-Z]+$/);
            if(!getName.test($("#youName").val())){
                $("#youNameComment").text("닉네임을 다시 설정하세요.");
                $("#youName").val("");
                return false;
            }
            ...
            if(!getBirth.test($("#youBirth").val())){
                $("#youBirthComment").text("생년월일을 정확하게 입력해주세요. ex)OOOO-OO-OO");
                return false;
            }
            ...
            if(!getPhone.test($("#youPhone").val())){
                $("#youPhoneComment").text("휴대폰 번호를 정확하게 입력해주세요. ex)OOO-OOOO-OOOO");
                return false;
            }
