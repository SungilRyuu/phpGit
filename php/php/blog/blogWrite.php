                        ...
                        <form action="blogWriteSave.php" name="blogWrite" method="POST" enctype="multipart/form-data">
                            <fieldset>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="blogTitle" id="blogTitle" placeholder="제목을 작성해주세요." required>
                                </div>
                                <div>
                                    <label for="blogContents">내용</label>
                                    <textarea name="blogContents" id="blogContents" placeholder="내용을 작성해주세요." required></textarea>
                                </div>
                                <div>
                                    <label for="blogImgFile">파일</label>
                                    <input type="file" name="blogImgFile" id="blogImgFile" placeholder="사진을 넣어주세요. 사진은 jpg, gif, png 파일만 지원이 됩니다."></input>
                                </div>
                                <div class="blog__btn">
