...
<main id="contents">
        ...
        <div class="container">
            ...
            <p class="section__desc">의뢰한 사항은 수정이 불가합니다.<br>새로운 글을 써주세요!</p>
    ...
    $sql = "SELECT r.requestID, r.requestTitle, r.requestContents, r.regTime, m.youName FROM myRequest r JOIN myMember m ON(m.memberID = r.memberID) WHERE r.requestID = {$requestID}";
